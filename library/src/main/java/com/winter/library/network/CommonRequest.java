    ...
    public static Request createMultiPostRequest(String url, RequestParams params) {
        ...
        if (params != null) {
            for (Map.Entry<String, Object> entry : params.fileParams.entrySet()) {
                ...
                requestBody.addFormDataPart(entry.getKey(), file.getName(), RequestBody.create(MediaType.parse("multipart/form-data")
                        , file));
            }
            for (Map.Entry<String, String> stringStringEntry : params.urlParams.entrySet()) {
                requestBody.addFormDataPart(stringStringEntry.getKey(), stringStringEntry.getValue());
            }
        }
