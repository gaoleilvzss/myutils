...
/**
 * @Author: 高磊
 * @Time: 2020/11/18 1:49 PM
 * @Description:
 */



import com.winter.library.network.cookie.SimpleCookieJar;
    ...
    static {
        ...
        okHttpClientBuilder.addInterceptor(new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                Request request =
                        chain.request().newBuilder().addHeader("Content-Type", "application/x-www-form-urlencoded") // 标明发送本次请求的客户端
                                .build();
